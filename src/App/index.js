        ...
        {apiBooks.map((newBook, index) => {
          return (
                  <li key={index} className="API-li">
                    ...
                    <a target="_blank" href={newBook.volumeInfo.canonicalVolumeLink}><img alt="Google API Image" src={newBook.volumeInfo.imageLinks.thumbnail} className="card-image"/></a>
