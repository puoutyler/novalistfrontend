...
const App = (props) => {
  ...
  const newBooks = (async () => {
      const response = await axios.get('https://www.googleapis.com/books/v1/volumes?q=programming&printType=books&intitle&key=AIzaSyAQNLb6ohAjiKiv_PIijuizvpZ1gOdSYz4&maxResults=6')
